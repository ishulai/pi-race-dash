...
# Request the GPIO pins as output
...
# Function to calculate the pulse period (high + low time) based on RPM or Speed
...
# Main loop to simulate both RPM and vehicle speed
try:
    ...
    while True:
        ...
        # Use a sine wave to smoothly vary the RPM and speed between min and max
        ...
        # Calculate the pulse periods for the current RPM and speed
        ...
        # Print the current RPM and speed for debugging purposes
        print(f"Simulated RPM: {rpm:.2f}, Simulated Speed: {speed:.2f} km/h")

except KeyboardInterrupt:
    print("Exiting...")

finally:
    # Release the GPIO lines when done
